...
public class SwingFindTheSpy1 extends JFrame implements ActionListener {
    JButton button1, button2, button3, button4, button5;
    JButton button6, button7, button8, button9, button10;

    public SwingFindTheSpy1() {
        ...
        button1 = new JButton("2156");
        button1.setName("button1");
        button1.addActionListener(this);

        button2 = new JButton("2265");
        button2.setName("button2");
        button2.addActionListener(this);

        button3 = new JButton("124");
        button3.setName("button3");
        button3.addActionListener(this);

        button4 = new JButton("2014");
        button4.setName("button4");
        button4.addActionListener(this);

        button5 = new JButton("1214");
        button5.setName("button5");
        button5.addActionListener(this);

        button6 = new JButton("562");
        button6.setName("button6");
        button6.addActionListener(this);

        button7 = new JButton("11");
        ...
        button9 = new JButton("213");
        button9.setName("button9");
        button9.addActionListener(this);

        button10 = new JButton("54136");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(SwingFindTheSpy1::new);
    }
}
